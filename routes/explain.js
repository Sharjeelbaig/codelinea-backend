...
const codeClassification = require("../public/javascripts/classifications/code");
...
router.post("/", cors(corsOptions), async (req, res) => {
  ...
  try {
    ...
    if (supportedLanguages.includes(language)) {
      ...
      const depthExplanation = await explainInDepth(
        code,
        language,
        explanation
      );
      ...
      res.json({
        ...
        sampleExplanation:
          "It is possible that the code you provided, is not a code, or having syntex errors or it can even possible that we don't support the language",
      });
    }
  } catch (error) {
    console.error(error);
